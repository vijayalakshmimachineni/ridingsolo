...
<html>
	...
	<body>
		<div class="container" style="margin:0">
				...
				<form class="" action="<?php echo baseURL1.'/updateExpeditionFaq'?>" method="POST" name="editFaqForm" id="editFaqForm">
		            ...
		            <input type="hidden" name="expedition_id" value="<?php echo $faq->expedition_id;?>">
		            <div class="mb-3">
