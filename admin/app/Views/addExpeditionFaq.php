...
<html>
	...
	<body>
		<div class="container" style="margin:0;">
				...
				<form class="" action="<?php echo baseURL1.'/saveExpeditionFaq'?>" method="POST" name="addFaqForm" id="addFaqForm">
		            ...
		            <input type="hidden" name="expedition_id" value="<?php echo $expedition_id;?>">
		            <div class="mb-3">
