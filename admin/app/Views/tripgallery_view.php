	                ...
	                <?php foreach ($galleryImages->gallery_image as $images) { ?>
	                  <div class="sortable" id="photoid_<?php echo $images->imageId;?>">
	                    ...
	                    <div class="gallery-tools"  >
	                      ...
	                      <div id="<?php echo $images->tripImageId;?>" title="Delete<?php echo $onlyname;?>" url=""  class="delete btn btn-danger" onClick="deletegallery('<?php echo $images->tripImageId;?>','<?php echo $onlyname;?>');"><i class="fa fa-trash"></i>
	                      </div>
