            ...
            <div class="row m-b-10">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="upload-dropzone-area" >
                  <div  id="assignment-dropzone" action="<?php echo baseURL1.'/addExpgallerydetails/'.$expedition_id;?>" class="dropzone dropzone-upload">
                    <div class="fallback">
	                ...
	                <?php foreach ($galleryImages->gallery_image as $images) { ?>
	                  <li class="sortable" id="photoid_<?php echo $images->imageId;?>">
	                    ...
	                    <div class="gallery-tools"  >
	                      <div id="<?php echo $images->imageId;?>" title="Delete<?php echo $images->imageName;?>" url=""  class="delete btn btn-danger" onclick="deletegallery('<?php echo $images->imageId;?>','<?php echo $onlyname;?>');"><i class="fa fa-trash"></i>
	                      </div>
			...
			function deletegallery(id,name){
				...
				Swal.fire({
				  ...
				  if (result.isConfirmed) {
				  	$.ajax({				      
				      method: "POST",
				      url: '<?php echo baseURL1."/galleryimagedelete";?>',
