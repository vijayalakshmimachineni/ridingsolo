            ...
            <div class="row m-b-10">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="upload-dropzone-area" >
                  <div  id="assignment-dropzone" action="<?php echo baseURL1.'/addHostelgallerydetails/'.$hostel_id;?>" class="dropzone dropzone-upload">
                    <div class="fallback">
              ...
              <div class="uploaded-images">
                ...
                <ul class="gallery" id="gallery">
	                <?php foreach ($galleryImages->gallery_image as $images) { ?>
	                  <li class="sortable" id="photoid_<?php echo $images->hostelgallery_id;?>">
	                    
	                    <?php $onlyname = end(explode('/', $images->imageName));?>
	                    <div class="gallery-tools"  >
	                      <div id="<?php echo $images->hostelgallery_id;?>" title="Delete<?php echo $images->imageName;?>" url=""  class="delete btn btn-danger" onclick="deletegallery('<?php echo $images->hostelgallery_id;?>','<?php echo $onlyname;?>');"><i class="icon-trash"></i>X
	                      </div>
		...
		console.log(id);
				Swal.fire({
				  ...
				  if (result.isConfirmed) {
				  	$.ajax({				      
				      method: "POST",
				      url: '<?php echo baseURL1."/deletehostelgallery";?>',
