   ...
   .form-control input
	...
	<body>
		<div class="container" style="margin:0">
			<form action="<?php echo baseURL1.'/expeditioniterinarystore'?>" method="post" name="adminform" id="adminform" enctype="multipart/form-data">
		...
		console.log(a);
				Swal.fire({
				  ...
				  if (result.isConfirmed) {
				      ...
				      type: "GET",
				      url: '<?php echo baseURL1."/deleteexpeditionitinerary/";?>'+a,
				      cache: false,
				      contentType: false,
				      processData: false,
