	...
	list-style: none;
		...
		<div class="container">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <a href="#"  class="btn btn-primary show-tooltip clearr m-r-10" id="clearr" style="" title="Clear Dropzone"><i class="icon-cloud-clear"></i> Clear Dropzone</a>
            ...
            <div class="row m-b-10">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div id="upload-dropzone-area" >
                  <div  id="assignment-dropzone" action="<?php echo baseURL1.'/addTripgallerydetails/'.$tripId;?>" class="dropzone dropzone-upload">
                    <div class="fallback">
	                ...
	                <?php foreach ($galleryImages->gallery_image as $images) { ?>
	                  <li class="sortable" id="photoid_<?php echo $images->image_id;?>">
	                    ...
	                    <div class="gallery-tools">
	                      <a href="#" id="<?php echo $images->image_id;?>" title="Delete<?php echo $images->imageName;?>" url=""  class="delete" onClick="deletegallery('<?php echo $images->imageId;?>','<?php echo $images->imageName;?>');"><i class="fa fa-trash"></i>
	                      </a>
	                    </div>
	                  </li>
	                  <?php } ?>   
			...
			function deletegallery(id,name){
				...
				Swal.fire({
				  ...
				  if (result.isConfirmed) {
				  	$.ajax({				      
				      method: "POST",
				      url: '<?php echo baseURL1."/deletebikegallery";?>',
