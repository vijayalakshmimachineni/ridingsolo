<?php 
    ...
    class LeisurePackages extends Controller 
    {
        ...
        public function saveFaq(){
            ...
            // var_dump($data);
            $model->saveFaq($data);
            return $this->response->redirect(baseURL1.'/leisurepackagesFaq/'.$data['leisure_id']); 
        }
        ...
        public function deleteLeisurePackagesFaq($faq_id,$leisure_id){
           ...
           return $this->response->redirect(baseURL1.'/leisurepackagesFaq/'.$leisure_id); 
        }
        ...
        public function addGalleryDetails($leisure_id){
            ...
            if($result){
                $data['galleryImages'] = $model->getGalleryimages($leisure_id); 
                return $this->response->redirect(baseURL1.'/leisurepackageGallery/'.$leisure_id); 
        ...
        public function storeleisure(){
           ...
           $rules = [            
            ...
            if($this->validate($rules)){ 
                ...
                return $this->response->redirect(baseURL1.'/leisurepackagesList'); 
                if($a->status ==200){
    ...
    function leisureiterinarystore(){
        ...
        for($i=0;$i<$c;$i++){
            if($entered['lpitinerary_id'][$i]){
                ...
                $a[] = $LeisurepackagesModel->editleisureiterinarydata($idata);                
            }           
        }
        if($a){
            $data['leisurePackages'] = $LeisurepackagesModel->getLeisurePackagesLists();   
            return view('leisurepackageslist_view',$data);    
