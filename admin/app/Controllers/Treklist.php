<?php 
    ...
    {  
        ...
        public function saveFaq(){
            ...
            // var_dump(($data));die();       
            $model->saveFaq($data);
            return $this->response->redirect(baseURL1.'/trekFaq/'.$data['trek_id']); 
        }
        ...
        public function deleteTrekFaq($faq_id,$trek_id){
           ...
           return $this->response->redirect(baseURL1.'/trekFaq/'.$trek_id); 
        }
        ...
        public function addGallerydetails($trek_id){
            ...
            if($result){
                $data['galleryImages'] = $model->getGalleryimages($trek_id); 
                return $this->response->redirect(baseURL1.'/trekGallery/'.$trek_id); 
        ...
        public function trekiterinarystore()   {
            ...
            if($a){
                ...
                return view('treklist_view',$data);*/
                return $this->response->redirect(baseURL1.'/trekList'); 
            }
        ...
        public function storetrek(){
            ...
            if($this->validate($rules)){ 
                ...
                if($a->status ==200){
                    ...
                    $data['validation'] = $this->validator;
                    return $this->response->redirect(baseURL1.'/addTrek/',$data);
                }
