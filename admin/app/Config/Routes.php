...
$routes->get('/deletetrekitinerary/(:any)', 'Treklist::deletetrekitinerary/$1');
...
$routes->post('/deletebikegallery','Biketrip::deletebikegallery');
$routes->get('/deletebikeitinerary/(:any)', 'Biketrip::deleteitineraryTrip/$1');
...
$routes->post('/galleryimagedelete','Expeditions::galleryimagedelete');
...
$routes->post('/deletelipgallery','LeisurePackages::galleryimagedelete');
...
$routes->post('/deletehostelgallery','Hostels::deletehostelgallery');
